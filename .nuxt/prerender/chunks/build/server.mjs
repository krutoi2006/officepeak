import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};globalThis.__timing__.logStart('Load chunks/build/server');import { hasInjectionContext, getCurrentInstance, inject, getCurrentScope, defineAsyncComponent, defineComponent, h, computed, unref, shallowRef, provide, shallowReactive, ref, createApp, isVNode, createCommentVNode, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, toRef, withCtx, Suspense, nextTick, Fragment, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'file://C:/Users/Krutoi2006/newOFFICEPEAK/node_modules/vue/index.mjs';
import { $fetch } from 'file://C:/Users/Krutoi2006/newOFFICEPEAK/node_modules/ofetch/dist/node.mjs';
import { b as baseURL } from '../_/renderer.mjs';
import { createHooks, createDebugger } from 'file://C:/Users/Krutoi2006/newOFFICEPEAK/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://C:/Users/Krutoi2006/newOFFICEPEAK/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file://C:/Users/Krutoi2006/newOFFICEPEAK/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, START_LOCATION, createMemoryHistory, createRouter } from 'file://C:/Users/Krutoi2006/newOFFICEPEAK/node_modules/vue-router/vue-router.node.mjs';
import { defu } from 'file://C:/Users/Krutoi2006/newOFFICEPEAK/node_modules/defu/dist/defu.mjs';
import { parseURL, encodePath, decodePath, hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://C:/Users/Krutoi2006/newOFFICEPEAK/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/Users/Krutoi2006/newOFFICEPEAK/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Cl6IWKNi.mjs')
  },
  {
    name: "page",
    path: "/:page()",
    component: () => import('./_page_-CZPso0fp.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import('./checkout-6eCYOKfX.mjs')
  },
  {
    name: "favorites",
    path: "/favorites",
    component: () => import('./favorites-DgjlnXm3.mjs')
  },
  {
    name: "product-id",
    path: "/product/:id()",
    component: () => import('./_id_-DTSfYhR2.mjs')
  },
  {
    name: "catalog",
    path: "/catalog",
    component: () => import('./index-CSnDGgZ9.mjs')
  },
  {
    name: "catalog-slug",
    path: "/catalog/:slug()",
    component: () => import('./_slug_-C1epasIg.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-zdzsJHKw.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D4BWc1fT.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-B4Eogm7d.mjs'));
