globalThis.__timing__.logStart('Load chunks/_/catalog');const unsplash = (id, width = 1600) => `https://images.unsplash.com/${id}?auto=format&fit=crop&w=${width}&q=86`;
const demoMedia = {
...
export { collections as a, products as b, categories as c, productById as p };;globalThis.__timing__.logEnd('Load chunks/_/catalog');
